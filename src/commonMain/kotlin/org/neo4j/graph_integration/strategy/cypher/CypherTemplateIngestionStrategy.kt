...
class CypherTemplateIngestionStrategy<KEY, VALUE>(query: String): IngestionStrategy<KEY, VALUE>() {
    ...
    override fun mergeNodeEvents(events: Collection<Entity<KEY, VALUE>>): IngestionEvent {
        return IngestionEvent(listOf(Event(fullQuery, events.mapNotNull{ it.value as? Map<String, Any> }.toList())))
    }
